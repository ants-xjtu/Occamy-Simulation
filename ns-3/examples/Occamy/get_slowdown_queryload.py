...
web_load_array = ["0.10"]
request_size_rate_array = ["0.8"]
request_flow_rate_array = ["0.100", "0.200", "0.300", "0.400", "0.500", "0.600", "0.700", "0.800"]
buffer_size_array = ["4194304"]
queue_num_array = ["2"]
performance_parameter = ["query_QCT_ave_slowdown", "web_FCT_ave_slowdown"]
...
def draw_query_load(folder_name):
                ...
                for buffer_size in buffer_size_array:
                    for queue_num in queue_num_array:
                        ...
                        for performance in performance_parameter:
                            ...
                            figure_name = (f"{performance}-{tcp_protocol}-XX-{web_load}-"
                                           f"{request_size_rate}-{buffer_size}-{queue_num}")
...
if __name__ == '__main__':
    ...
    file_dir = "100g_queryload/"
    data_output_file = "data/100g_queryload.txt"
    figure_output_folder = "figure/100g_queryload/"
    ...
    draw_query_load(figure_output_folder)