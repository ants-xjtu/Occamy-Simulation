 ...
 */
#ifndef SHARED_MEMORY_POINT_TO_POINT_HELPER_H
#define SHARED_MEMORY_POINT_TO_POINT_HELPER_H
 ...
 * "mixins".
 */
class SharedMemoryPointToPointHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
    /**
     * Create a SharedMemoryPointToPointHelper to make life easier when creating point to
     * point networks.
     */
    SharedMemoryPointToPointHelper();

    ~SharedMemoryPointToPointHelper() override
    {
    }
     ...
     * PointToPointNetDevice created through SharedMemoryPointToPointHelper::Install.
     */
     ...
     * by SharedMemoryPointToPointHelper::Install
     */
     ...
     * attributes configured by SharedMemoryPointToPointHelper::SetChannelAttribute,
...
template <typename... Ts>
void
SharedMemoryPointToPointHelper::SetQueue(std::string type, Ts&&... args)
{
